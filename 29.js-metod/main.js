...
text.replaceAll("Java", "JavaScrip");
console.log(text.replaceAll("Java", "JavaScrip"));
// ---------------------
...
longestWord("Hello word hi programmers");
...
let firstPerson = persons.find(
  (item) => item.name === "Aysu" && item.age === 32
);
...
console.log(
  persons.findIndex((item) => item.name === "Aysu" && item.age === 32)
);
