...
let card = document.querySelector(".producs-card");
...
<div class="card" style="width: 18rem">
  ...
  <div class="card-body">
    ...
    <h5 class="card-price">Price:${el.price}</h5>
    <p class="card-description">
    ${el.description}
    </p>
    <div >
    <button class="btn btn-primary" onclick=addtoBasket('${el._id}')>Add to Basket</button>
