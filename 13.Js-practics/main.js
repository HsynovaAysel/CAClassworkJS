...
// function reversNum(par) {
//    let reverse=String(par).split('').reverse().join('')
//    return reverse
// }
...
//  function acsendingStr(par) {
//      let acsending= par.split('').sort().join('')
//      return acsending
//   }
//    console.log(acsendingStr('webmaster'));
...
//         array.push(el.charAt(0).toLocaleUpperCase() + el.slice(1));
//     });
//     return array.join(" ")
// }
